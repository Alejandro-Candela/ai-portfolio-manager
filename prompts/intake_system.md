...
- After collecting all 5 fields, output a short summary and the JSON block below.

## Completion format

When all fields are collected, first write a 2–3 sentence plain-language summary, then output:
...
```json
{
  ...
  "use_case": {
    ...
    "stakeholders": ["<role or group>"],
    "available_data": "<brief description>",
